...
namespace Pokemon3D.GameModes.Pokemon
{
    ...
    class PokemonFactory
    {
        ...
        /// </summary>
        public Pokemon Create(string id)
        {
            var dataModel = GetDefinitionModel(id);
            var saveModel = new PokemonSaveModel();

            PopulateSaveModel(dataModel, ref saveModel);
        ...
        private void PopulateSaveModel(PokemonModel dataModel, ref PokemonSaveModel saveModel)
        {
