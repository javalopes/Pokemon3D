...
namespace Pokemon3D.Screens
{
    internal class IntroIScreen : IScreenWithOverlays
    {
        ...
        public override void OnOpening(object enterInformation)
        {
            ...
            logoSprite.SetPosition(new Vector2(window.ScreenBounds.Width * 0.5f, window.ScreenBounds.Height * 0.5f));
            ...
            highlightSprite.SetPosition(new Vector2(window.ScreenBounds.Width * 0.5f+30, window.ScreenBounds.Height * 0.5f-160));
        ...
        {
            GameInstance.GetService<ScreenManager>().SetScreen(typeof(MainMenuIScreen));
        }
