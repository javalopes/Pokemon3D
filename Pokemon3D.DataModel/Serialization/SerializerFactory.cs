namespace Pokemon3D.DataModel.Serialization
{
    internal static class SerializerFactory
    {
        ...
        /// </summary>
        public static IDataSerializer<T> GetSerializer<T>(string data)
        {
        ...
        /// </summary>
        public static IDataSerializer<T> GetJsonSerializer<T>()
        {
            return new JsonIDataSerializer<T>();
        }

        /// <summary>
        /// Returns the appropriate data serializer.
        /// </summary>
        public static IDataSerializer<T> GetSerializer<T>(DataType dataType)
        {
            switch (dataType)
            {
                case DataType.Json:
                    return new JsonIDataSerializer<T>();
                case DataType.Xml:
                    return new XmlIDataSerializer<T>();
                default:
                    return null;
            }
        }
