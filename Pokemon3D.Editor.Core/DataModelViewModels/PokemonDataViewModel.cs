...
namespace Pokemon3D.Editor.Core.DataModelViewModels
{
    public class PokemonDataViewModel : DataModelViewModel
    {
        ...
        public PokemonDataViewModel(PokemonModel model) : base(model, nameof(PokemonModel))
        {
            ...
            AddProperty(new ObjectDataModelPropertyViewModel(d => SetDataViewModelProperty(ref _model.PokedexEntry, d), new PokedexEntryDataViewModel(_model.PokedexEntry), nameof(_model.PokedexEntry)));
            ...
            AddProperty(new DoubleDataModelPropertyViewModel(b => _model.IsMale = b, _model.IsMale, nameof(_model.IsMale)));
