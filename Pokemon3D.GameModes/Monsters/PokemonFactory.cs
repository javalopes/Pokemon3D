...
namespace Pokemon3D.GameModes.Monsters
{
    ...
    public class PokemonFactory
    {
        ...
        public Pokemon GetPokemon(string pokemonId, int level)
        {
            ...
            {
                var d = _gameMode.IFileLoader.GetFile(_gameMode.GetPokemonFilePath(pokemonId));
        ...
        public Pokemon GetPokemon(PokemonSaveModel saveModel)
        {
            ...
            {
                var d = _gameMode.IFileLoader.GetFile(_gameMode.GetPokemonFilePath(saveModel.Id));
        ...
        private string GeneratePersonalityValue()
        {
            ...
            while (personalityValue.Length < PersonalityValueLength)
                personalityValue += ((char)_charCodes[_gameMode.IGameContext.GetService<Random>().Next(0, _charCodes.Length)]).ToString();
        ...
        {
            var random = _gameMode.IGameContext.GetService<Random>();
            ...
            saveModel.IsShiny = (random.Next(0, 4096) == 0);
