    ...
    public class PokemonFactory
    {
        ...
        private string GeneratePersonalityValue()
        {
            ...
            while (personalityValue.Length < PersonalityValueLength)
                personalityValue += ((char)_charCodes[_gameMode.GameContext.GetService<Random>().Next(0, _charCodes.Length)]).ToString();
        ...
        {
            var random = _gameMode.GameContext.GetService<Random>();
